...
productname="BME680 Breakout" # the name of the product to install
scriptname="bme680" # the name of this script
...
osdeny=( "Darwin" "Debian" "Kali" "Linaro" "OSMC"  "Ubuntu" "Volumio" ) # list os-releases specifically disallowed
debpackage="bme680" # the name of the package in apt repo
piplibname="bme680" # the name of the lib in pip repo
...
localdir="bme680" # the name of the dir for copy of resources
gitreponame="bme680" # the name of the git project repo
